                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            {{ $news_item->updated_at->format('d.m.Y \o\ H:i') }}
                            <div>
                                <a href="{{ route('news.show', $news_item->slug) }}" class="btn btn-info btn-xs" target="_blank">
                                    Попередній перегляд
                                </a>
                            </div>
                        </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="fileUpload">
                            ...
                            <img src="{{\Illuminate\Support\Facades\Storage::url($news_item->main_image)}}">
                        </div>
                    </div>
                </div>
            </div>
