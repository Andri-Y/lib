                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            {{ $book->updated_at->format('d.m.Y \o\ H:i') }}
                            <div>
                                <a href="{{ route('books.show', $book->slug) }}" class="btn btn-info btn-xs" target="_blank">
                                    View Post
                                </a>
                            </div>
                        </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="fileUpload">
                            ...
                            <img src="{{\Illuminate\Support\Facades\Storage::url($book->main_image)}}">
                        </div>
                    </div>
                </div>
            </div>
